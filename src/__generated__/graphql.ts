...
export type MyProfileQuery = { __typename?: 'Query', myProfile: { __typename?: 'User', id: string, email: string, password: string, name: string, role: string, avatar: string, creationAt: any, updatedAt: any } };
